 ...
 *  副总经理类
 * */
public class ViceManger implements InterfaceLead {
    // 名字
    private String name;
    // 职位
    private String jop;
    ...
    public ViceManger(String name, String jop) {
        this.name = name;
        this.jop = jop;
    }
    ...
    public void requsetHanddle(Applicant staff) {
        ...
        if (staff.getNumberOfFunds() <= 100000.0 && staff.getNumberOfFunds() > 200000.0) {
            //申请成功
